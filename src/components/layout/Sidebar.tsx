...
const GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { to: "/customer-garage", label: "سيارات العملاء", icon: CarFront, permission: "customers", feature: "vehicleCatalog" },
      ...
      { to: "/warranty-center", label: "مركز الضمان", icon: ShieldCheck, permission: "returns", feature: "warrantyCenter" },
    ],
  },
  {
    id: "catalog",
    ...
    items: [
      ...
      { to: "/vehicle-catalog", label: "كتالوج توافق السيارات", icon: CarFront, permission: "products", feature: "vehicleCatalog" },
      { to: "/part-alternatives", label: "بدائل قطع الغيار", icon: Link2, permission: "products", feature: "partAlternatives" },
      { to: "/parts-finder", label: "مستكشف ودليل القطع", icon: PackageSearch, permission: "products", feature: "vehicleCatalog" },
