...
export const RELEASES: Release[] = [
  {
    ...
    highlights: [
      {
        title: "إصلاح جذري لتطبيق الموبايل: تسجيل الدخول، الخروج، والمزامنة",
        description: "التطبيق كان يتصل بعنوان تطوير محلي بدل خادم PartFlow الحقيقي فتفشل كل عملية اتصال. تم تصحيح العنوان الافتراضي، وزر تسجيل الخروج بقى يعمل فعليًا مع رسالة واضحة، والبيانات بترجع تتزامن بشكل طبيعي.",
        tone: "fix",
      },
      {
        title: "تسجيل دخول أسرع على الموبايل بعد أول ربط",
        description: "كود الربط من السيستم مطلوب مرة واحدة بس. بعدها التطبيق بيتذكر الجهاز، وتسجيل الدخول بيبقى بالحساب وكود 2FA فقط.",
        tone: "feature",
      },
      {
        title: "قائمة الأجهزة المرتبطة بالموبايل",
        description: "شاشة جديدة في الإعدادات تعرض كل جهاز مربوط بحساب المتجر — الاسم، النوع، تاريخ الربط، آخر نشاط — مع إمكانية تسجيل خروج أو إلغاء ربط أي جهاز عن بُعد.",
        tone: "feature",
      },
      {
        title: "نسخة PWA لتطبيق الويب — تركيب مباشر على أي جهاز",
        description: "نسخة الويب من تطبيق PartFlow بقت قابلة للتركيب كتطبيق مستقل على الموبايل والكمبيوتر، وتوافقت شاشتها مع الآيفون (كانت بتظهر مصغّرة بسبب إعداد ناقص).",
        tone: "feature",
      },
      {
        title: "النسخة السحابية الكاملة لبيانات المتجر (إضافة مدفوعة مستقلة)",
        description: "نسخة مشفّرة بكلمة سر تخصك من كل بيانات المتجر — موردين، مشتريات، مصروفات، مرتجعات، فروع، إعدادات — تُرفع للسحابة تلقائيًا بحيث تكون بياناتك محلية وسحابية معًا، وقابلة للاستعادة على أي جهاز. حتى نحن لا نقدر نقرأها.",
        tone: "feature",
      },
    ],
  },
